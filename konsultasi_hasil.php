   ...
   <div class="panel-heading">        
    ...
    <div class="panel-body">
        <table class="table table-bordered">
            ...
            <tr>
                <td>Penyebab</td>
                <td><?=$DIAGNOSA[$key]->penyebab?></td>
            </tr>
            <tr>
                <td>Solusi</td>
                <td><?=$DIAGNOSA[$key]->solusi?></td>
            </tr>
        </table>
                <p>
...
<div class="page-header">
    ...
    $db->query("INSERT INTO tb_hasil(nama, no_hp,jk,alamat,tgl,hasil_konsultasi) VALUES('$nama','$no_hp','$jk','$alamat','$tgl','$hasildiagnosa')");
