...
<html lang="en">
  <head>
    ...
    .hi{
background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url('anak.jpg');
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?m=relasi" class="t"><b>Basis Pengetahuan</b></a></li>    
            <li><a href="?m=rule" class="t"><b>Aturan</b></a></li>    
            <li><a href="?m=laporan" class="t"><b>Laporan Konsultasi</b></a></li>
